                            ...
                            <td class="px-4 py-3">
                                <form method="POST" action="{{ route('guru.validasi-tempat.validate', $item->id) }}">
                                    ...
                                    @php
                                        ...
                                        $disabled = !$item->status_pengajuan || $item->status_validasi == 'diterima';
                                    @endphp
                                    ...
                                    <select name="status_validasi"
                                        ...
                                        <option value="diterima" {{ $current == 'diterima' ? 'selected' : '' }}>
                                            Setujui
                                        </option>

                                        <option value="ditolak" {{ $current == 'ditolak' ? 'selected' : '' }}>
                                            Tolak
                                        </option>
                                    ...
                                    @if(!$item->status_pengajuan)
                                        ...
                                        <button disabled
                                            class="w-full bg-gray-300 text-gray-600 text-xs px-3 py-2 rounded">
                                            Tidak Ada Pengajuan
                                        </button>
                                    ...
                                    @elseif($item->status_validasi == 'diterima')
                                        ...
                                        <button disabled
                                            class="w-full bg-gray-400 text-white text-xs px-3 py-2 rounded">
                                            Sudah Disetujui
                                        </button>
